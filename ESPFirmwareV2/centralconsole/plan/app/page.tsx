...
import { Shield, Settings, Activity, ChevronRight } from "lucide-react"
...
export default function TFTDisplay() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-neutral-900 p-4">
      ...
      <div 
        className="relative bg-neutral-950 rounded-lg overflow-hidden shadow-2xl border border-neutral-800"
      ...
      >
        ...
        <div className="absolute top-8 left-0 right-0 bottom-9 p-4">
          ...
          <div className="space-y-2.5">
            ...
            {/* Settings Button */}
            <button className="w-full flex items-center justify-between p-3 bg-neutral-900/80 rounded-xl border border-neutral-800 group">
              <div className="flex items-center gap-3">
